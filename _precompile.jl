...
precompile(Tuple{typeof(Base.filter), PromptedNotes.var"#1#4", Array{OrderedCollections.OrderedDict{String, Any}, 1}})
...
precompile(Tuple{typeof(Base._any), PromptedNotes.var"#2#5", Array{OrderedCollections.OrderedDict{String, Any}, 1}, Base.Colon})
precompile(Tuple{typeof(Base.length), Array{OrderedCollections.OrderedDict{String, Any}, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, PromptedNotes.var"#3#6", Array{OrderedCollections.OrderedDict{String, Any}, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{OrderedCollections.OrderedDict{String, Any}, 1}, PromptedNotes.var"#3#6"}})
precompile(Tuple{typeof(Base._array_for), Type{String}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{String, 1}, String, Base.Generator{Array{OrderedCollections.OrderedDict{String, Any}, 1}, PromptedNotes.var"#3#6"}, Int64})
...
precompile(Tuple{typeof(PromptedNotes.replace_braces), String, OrderedCollections.OrderedDict{Any, Any}})
